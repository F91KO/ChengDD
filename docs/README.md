...
| [Agent成长路线图.md](./02-architecture/Agent成长路线图.md) | 设计基线 | Agent 如何从内部诊断成长为运维处置与客户支持机器人 |
...
| [测试Sub-Agent执行规范.md](./05-delivery/测试Sub-Agent执行规范.md) | 执行说明 | 测试 agent 的模型选择、提示词模板、报告输出与失败处理规范 |
| [服务级Agent清单.md](./05-delivery/服务级Agent清单.md) | 执行说明 | 按服务划分的 agent 名称、职责边界、写入范围与验证命令 |
...
| [当前任务收口清单.md](./05-delivery/当前任务收口清单.md) | 执行说明 | 当前工作区与 GitHub issue 的映射、建议提交批次与收口顺序 |
| [前端交付与验收说明.md](./05-delivery/前端交付与验收说明.md) | 执行说明 | `cdd-frontend` 安装/运行/测试指引 + 报告与风险 |
| [设备切换开发交接记录-2026-03-23.md](./05-delivery/设备切换开发交接记录-2026-03-23.md) | 执行说明 | 当前已推送内容、本地未提交内容、换设备接续步骤与风险提示 |
