...
class ProductControllerIntegrationTest {
    ...
    void shouldSupportProductEditEndpointAndRefreshListSummary() throws Exception {
        ...
        mockMvc.perform(put("/api/product/spu/{product_id}", created.id())
        ...
        assertThat(productNode.path("stock_summary").path("total_available_stock").asInt()).isEqualTo(70);
        assertThat(productNode.path("sku_summaries")).hasSize(2);
        assertThat(productNode.path("sku_summaries").get(0).path("sku_name").asText()).isEqualTo("小份");
        assertThat(productNode.path("sku_summaries").get(1).path("sku_name").asText()).isEqualTo("大份");
