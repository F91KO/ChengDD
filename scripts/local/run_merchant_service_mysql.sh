...
if [[ -z "$settings_file" ]]; then
  settings_file="$(mktemp /tmp/chengdd-merchant-mvn-settings.XXXXXX)"
...
export CDD_MERCHANT_DB_URL="${CDD_MERCHANT_DB_URL:-jdbc:mysql://127.0.0.1:${mysql_port}/${mysql_database}?useUnicode=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai&useSSL=false}"
export CDD_MERCHANT_DB_USERNAME="${CDD_MERCHANT_DB_USERNAME:-$mysql_username}"
